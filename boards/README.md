...
`ttgo_tdisplay_s3.csv` targets the standard LilyGO TTGO T-Display S3. Build it with the ESP32-S3 configuration, then flash its generated hardware-NVS binary at `0x422000`; see the T-Display S3 section in the root README.
